...
a2 = [0,latr,0]
a3 = [0,0,latr]
pos = [[0,0,0],[0.5*latr,0.5*latr,0.5*latr]]
types = ['A','B']
mtypes = ['EA','EB']
ucell = hoomd.lattice.unitcell(Ntypes, a1, a2, a3, dimensions=3, position=pos,
                               type_name=mtypes)

system = init.create_lattice(unitcell = ucell, n=[5,5,5]) 
...
dump.gsd(filename='mols10000_AAA-SCSCSCA-SCSCSCB-ERADA-ERADB_short_runRUN.gsd',period=25000,group=group.all(),phase=0)
