...
beadMass = 1
beadR = 0.5
ebeadR=[ERADA/(2.**(5./6.)),ERADB/(2.**(5./6.))]
lbeadR = 0.125
...
a2 = [0,latr,0]
a3 = [0,0,latr]
pos =[[0.33*latr,0.33*latr,0.1667*latr],[0.66*latr,0.66*latr,0.1667*latr],
      [0.33*latr,0.66*latr,0.1667*latr],[0.66*latr,0.33*latr,0.1667*latr],
      [0.33*latr,0.33*latr,0.3333*latr],[0.66*latr,0.66*latr,0.3333*latr],
      [0.33*latr,0.66*latr,0.3333*latr],[0.66*latr,0.33*latr,0.3333*latr],
      [0.33*latr,0.33*latr,0.5*latr],[0.66*latr,0.66*latr,0.5*latr],
      [0.33*latr,0.66*latr,0.5*latr],[0.66*latr,0.33*latr,0.5*latr],
      [0.33*latr,0.33*latr,0.6667*latr],[0.66*latr,0.66*latr,0.6667*latr],
      [0.33*latr,0.66*latr,0.6667*latr],[0.66*latr,0.33*latr,0.6667*latr],
      [0.33*latr,0.33*latr,0.8333*latr],[0.66*latr,0.66*latr,0.8333*latr],
      [0.33*latr,0.66*latr,0.8333*latr],[0.66*latr,0.33*latr,0.8333*latr]]
types = ['A','B']
mtypes = MIXARRAY
...
dump.gsd(filename='mols10000_AAA-SCSCSCA-SCSCSCB-ERADA-ERADB_runRUN.gsd',period=5000,group=group.all(),phase=0)
dump.gsd(filename='mols10000_AAA-SCSCSCA-SCSCSCB-ERADA-ERADB_short_runRUN.gsd',period=20000,group=group.all(),phase=0)
...
analyze.log(filename='mols10000_AAA-SCSCSCA-SCSCSCB-ERADA-ERADB_runRUN.log',quantities=['potential_energy','kinetic_energy','langevin_reservoir_energy_rigid_center','temperature','pressure'],period=50000,phase=0)
try:
