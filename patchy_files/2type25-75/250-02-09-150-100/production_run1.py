...
types = ['A','B']
mtypes = ["EB","EA","EB","EA","EA","EB","EB","EA","EB","EB","EB","EB","EB","EB","EB","EB","EA","EB","EB","EB"]
ucell = hoomd.lattice.unitcell(20, a1, a2, a3, dimensions=3, position=pos,
                               type_name=mtypes)

system = init.create_lattice(unitcell = ucell, n=[1,1,1]) 
...
gsd_restart = dump.gsd(filename="restart_run1.gsd",group=group.all(),truncate=True,period=200000,phase=0)
dump.gsd(filename='mols10000_250-02-09-150-100_run1.gsd',period=5000,group=group.all(),phase=0)
dump.gsd(filename='mols10000_250-02-09-150-100_short_run1.gsd',period=25000,group=group.all(),phase=0)
...
analyze.log(filename='mols10000_250-02-09-150-100_run1.log',quantities=['potential_energy','kinetic_energy','langevin_reservoir_energy_rigid_center','temperature','pressure'],period=50000,phase=0)
try:
	run_upto(2e6,limit_multiple=2000)
