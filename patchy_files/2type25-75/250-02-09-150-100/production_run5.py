...
types = ['A','B']
mtypes = ["EB","EA","EB","EB","EB","EB","EB","EB","EB","EB","EA","EA","EB","EA","EB","EA","EB","EB","EB","EB"]
...
gsd_restart = dump.gsd(filename="restart_run5.gsd",group=group.all(),truncate=True,period=200000,phase=0)
dump.gsd(filename='mols10000_250-02-09-150-100_run5.gsd',period=5000,group=group.all(),phase=0)
dump.gsd(filename='mols10000_250-02-09-150-100_short_run5.gsd',period=25000,group=group.all(),phase=0)
...
analyze.log(filename='mols10000_250-02-09-150-100_run5.log',quantities=['potential_energy','kinetic_energy','langevin_reservoir_energy_rigid_center','temperature','pressure'],period=50000,phase=0)
try:
